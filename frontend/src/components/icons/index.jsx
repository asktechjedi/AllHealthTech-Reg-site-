// SVG Icon Components — stroke-based, currentColor, no emojis
...
export function TicketIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <path d="M9 5v14M15 5v14" strokeDasharray="2 2" />
    </svg>
  )
}
...
export function BrainIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M9.5 2a4.5 4.5 0 014.5 4.5v.5h.5a3.5 3.5 0 010 7H9.5A4.5 4.5 0 015 10V6.5A4.5 4.5 0 019.5 2z" />
      <path d="M14.5 7H15a3.5 3.5 0 010 7h-.5" />
      <path d="M9.5 14.5V22M12 14.5V22M14.5 14.5V22" />
      <path d="M7 10h2M7 7h2" />
    </svg>
  )
}
...
export function MicroscopeIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M9 3h6v10H9z" rx="1" />
      <path d="M9 7H7a1 1 0 00-1 1v2a1 1 0 001 1h2" />
      <path d="M12 13v5" />
      <path d="M8 21h8" />
...
export function PillIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M10.5 3.5a5 5 0 017.07 7.07l-7.07 7.07a5 5 0 01-7.07-7.07l7.07-7.07z" />
      <path d="M7 7l10 10" />
    </svg>
  )
}
...
export function CheckIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function PhoneIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M6.6 10.8a15.05 15.05 0 006.6 6.6l2.2-2.2a1 1 0 011.1-.24 11.5 11.5 0 003.6 1.15 1 1 0 011 1V21a1 1 0 01-1 1A17 17 0 013 5a1 1 0 011-1h3.5a1 1 0 011 1 11.5 11.5 0 001.15 3.6 1 1 0 01-.25 1.1L6.6 10.8z" />
    </svg>
  )
}
...
export function RefundIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
