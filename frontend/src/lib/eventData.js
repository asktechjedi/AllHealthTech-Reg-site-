...
const speakerRecords = [
  {
    ...
    highlights: [
      { label: 'Current', value: 'Vice President, Prime Venture Partners' },
  ...
  {
    id: 'speaker-jhanvi-shah',
    name: 'Jhanvi Shah',
    title: 'Moderator',
    organization: 'All Health Tech',
    tagline: '',
    biography: '',
    photoUrl: jhanviShahPhoto,
    photoPosition: 'center top',
    linkedinUrl: '',
    twitterUrl: '',
    isFeatured: false,
  ...
  {
    id: 'speaker-sunanda-jayaseelan',
    name: 'Sunanda Jayaseelan',
    title: 'Moderator',
    organization: '',
    tagline: '',
    biography: '',
    photoUrl: sunandaJayaseelanPhoto,
    photoPosition: 'center top',
    linkedinUrl: '',
    twitterUrl: '',
    isFeatured: false,
...
const agendaRecords = [
  ...
  },
  {
    ...
    speakerId: null,
    speakers: [
      { speakerId: 'speaker-sunanda-jayaseelan', name: 'Sunanda Jayaseelan', role: 'Moderator',organization: 'Journalist, Podcaster, Media & Crisis Communications Coach' },
      { speakerId: 'speaker-ujjvala-ballal-shetty', name: 'Dr. Ujjvala Shetty' },
      { speakerId: 'speaker-dr-karamveer-chhabra', name: 'Dr. Karamveer' },
      { speakerId: 'speaker-sunny-kichloo', name: 'Sunny Kichloo' },
      { speakerId: 'speaker-dr-ramesh-karmegam', name: 'Dr. Ramesh Karmegam' },
    ],
  },
  {
    id: 'session-fireside',
    ...
    speakers: [
      { speakerId: 'speaker-sunanda-jayaseelan', name: 'Sunanda Jayaseelan', role: 'Moderator',organization: 'Journalist, Podcaster, Media & Crisis Communications Coach' },
      { speakerId: 'speaker-dr-bhaskar-rajakumar', name: 'Dr.Bhaskar Rajakumar ' },
  ...
  },
  {
    ...
    startTime: '2026-07-27T13:05:00+05:30',
    endTime: '2026-07-27T13:30:00+05:30',
    track: 'Panel',
    type: 'panel',
    description: 'Compliance Considerations for AI-Powered Diagnostics in Clinical Workflows.',
    speakerId: null,
    speakers: [
  ...
  },
  {
    ...
    displayOrder: 10,
    title: 'Lunch Break',
    startTime: '2026-07-27T13:30:00+05:30',
  ...
  // },
  {
    ...
    track: 'Panel',
    type: 'panel',
    description: 'Building healthtech that actually gets used. Founder lessons on adoption, trust, and scaling healthcare innovation',
    speakerId: null,
    speakers: [
      ...
      { speakerId: 'speaker-raghuvamshi-thakur' },
      { speakerId: 'speaker-pradeep-vamana',name: 'Pradeep Vamana', organization: 'Prodancy'  },
    ],
  },
  {
    id: 'session-pitch',
    ...
    track: 'Interactive',
    type: 'interactive',
    description: 'Selected startups get to showcase and pitch their innovations to our VC panel and an audience of healthcare leaders, investors, and ecosystem stakeholders.',
    speakerId: null,
    speakers: [],
  },
  {
    id: 'session-panel-4',
    displayOrder: 14,
    title: 'Panel: The VC Perspective — AI & Agents and the healthcare ecosystem',
    startTime: '2026-07-27T15:45:00+05:30',
    endTime: '2026-07-27T16:10:00+05:30',
    track: 'Panel',
    type: 'panel',
    description: 'What investors believe will define the next decade of healthcare innovation.',
    speakerId: null,
    speakers: [
      { speakerId: 'speaker-sunanda-jayaseelan', name: 'Sunanda Jayaseelan', role: 'Moderator',organization: 'Journalist, Podcaster, Media & Crisis Communications Coach' },
      ...
      { speakerId: 'speaker-shivani-kulkarni', name: 'Shivani', organization: 'Prime Venture Partners' },
  ...
  },
  {
    ...
    speakerId: null,
    speakers: [
      { speakerId: 'speaker-jhanvi-shah', name: 'Jhanvi Shah',organization: 'All Health Tech', role: 'Moderator' },
  ...
  },
  {
    id: 'session-panel-6',
    displayOrder: 19,
    title: 'Panel: AI, Trust & Healthcare Marketing',
    startTime: '2026-07-27T17:45:00+05:30',
    endTime: '2026-07-27T18:10:00+05:30',
    track: 'Panel',
    type: 'panel',
    description: 'From discovery to care: Building trust across every patient touchpoint.',
    speakerId: null,
    speakers: [
...
export function getEventData() {
  ...
  const listedSpeakers = speakers.filter((speaker) => !speaker.agendaOnly)

  return {
    speakers: attachSessionsToSpeakers(listedSpeakers, agendaItems),
    agendaItems,
  }
}
