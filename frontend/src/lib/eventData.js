...
const agendaRecords = [
  ...
  },
  {
    ...
    track: 'Panel',
    type: 'panel',
    description: 'Navigating policy, regulation, data governance, and legal considerations in healthcare innovation. Moderator: Ishitha.',
    speakerId: null,
    speakers: [
      { speakerId: 'speaker-ishitha', name: 'Ishitha', role: 'Moderator' },
